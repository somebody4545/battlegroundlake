...
function Page5() {  // eslint-disable-line
    const {scene, cameras} = useGLTF('/static/models/page5.glb')
    const {set} = useThree()
    const terrainRef = useRef()
    const lastFrameTime = useRef(Date.now())
    useEffect(() => {
...
function Page6() {  // eslint-disable-line
    const {scene, cameras} = useGLTF('/static/models/page6.glb')
    const {set} = useThree()
    const terrainRef = useRef()
    const lastFrameTime = useRef(Date.now())
    useEffect(() => {
...
function Page7() {  // eslint-disable-line
    const {scene, cameras} = useGLTF('/static/models/page7.glb')
    const {set} = useThree()
    const terrainRef = useRef()
    const lastFrameTime = useRef(Date.now())
    useEffect(() => {
...
function Page8() {  // eslint-disable-line
    const {scene, cameras} = useGLTF('/static/models/page8.glb')
    const {set} = useThree()
    const terrainRef = useRef()
    const lastFrameTime = useRef(Date.now())
    useEffect(() => {
...
function Page9() {  // eslint-disable-line
    const {scene, cameras} = useGLTF('/static/models/page9.glb')
    const {set} = useThree()
    const terrainRef = useRef()
    const lastFrameTime = useRef(Date.now())
    useEffect(() => {
...
export default function App() {
    ...
    function Runner({counter}) {
        switch (counter) {
                    ...
                    <>
                        ...
                        <div
                            ...
                            <p>
                                ...
                                became filled with precipitation such as rain and snow (McDonald, 2009). It was formed around
                                100,000 years ago (Genis, 2021), and is part of the Boring Lava Field, around the
                                Portland-Vancouver border between Washington and Oregon (Ruth, 2018).
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
                    ...
                    <>
                        ...
                        <div
                            ...
                            <p><h2 className={'text-[4vh] font-bold font-sans'}>Summary</h2>
                                ...
                                next to it, which never truly was a "battle ground" (Ruth, 2018). Rather, it was named after a
                ...
                return (
                    <>
                        ...
                        <div
                            ...
                            <p className={"h-[75%] overflow-y-scroll"}>
                                ...
                                (Caldbick, 2010). The conflict led to imprisonment of many American Indians to avoid the
                                chance of their revolt (Caldbick, 2010), akin to the method in which Japanese would later be
                                detained in World War II. One of these groups were the Klickitat, captured by the
                                Vancouver Barracks, an early military post in the Pacific Northwest (Caldbick, 2010).
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
                    ...
                    <>
                        ...
                        <div
                            ...
                            <p className={"h-[50%] overflow-y-scroll"}>
                                ...
                                “battle” as the name would make it seem (Ruth, 2018), but rather, ended short when Chief
                                Umtuch was shot by an unknown individual, resulting in a quick surrender and return to
                                the Barracks (Caldbick, 2010).
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
                    ...
                    <>
                        ...
                        <div
                            ...
                            <p className={""}>
                                ...
                                and is currently a popular fishing spot. (Genis, 2021)
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
                ...
                return (
                    <>
                        <div className={'absolute p-[10%] w-[40%] h-full z-10 text-left text-[1.5vh]'}>
                            ...
                            <h1>Geography and Recreation</h1>
                        </div>
                        <div
                            className={'absolute p-[10%] w-[70%] left-[30%] h-full z-10 text-left text-[2.5vh] flex flex-col'}>
                            ...
                            <p className={""}>
                                ...
                                With no rivers connecting the lake to any other water way (Hewitt, 2023), fish aren't
                                available. The solution though, as done when it was a resort and now, is to manually
                                restock the fish
                                specifically for recreational purposes (Genis, 2021).
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
                    ...
                    <>
                        ...
                        <div
                            ...
                            <p className={""}>
                                ...
                                lakes formed by other means (Genis, 2021).
                            </p>
                            <button onClick={incrementCounter}
                                    className={'m-[1vh] bg-blue-500 hover:bg-blue-700 text-white py-[0.5vh] px-4 rounded-full font-sans text-[2vh] ml-auto transition-colors'}>
                                Next
            ...
            case 10:
                return (<>
                    <div className={'absolute p-[10%] w-[100%] h-full z-10 text-left text-[1.5vh]'}>
                        <h1 className={"text-[5vh]"}>Want to Learn more?</h1>
                        <br/>
                        <ul className={"text-[3vh] list-disc"}>
                            <li>
                                <a href="https://parks.wa.gov/find-parks/state-parks/battle-ground-lake-state-park"><p
                                    className={"text-blue-500"}>Check out the wa.gov page for travel info!</p>
                                </a>
                            </li>
                            <li>
                                <a href="/static/supplementary.pdf"><p
                                    className={"text-blue-500"}>Supplementary Information (Sources and additional research)</p></a>
                            </li>
                        </ul>
                    </div>
                </>)
    ...
    return (
        <>
            ...
            <div className={"fixed bottom-[1vh] right-[3vh] text-black font-sans text-[2vh] p-5"}>
                <p>View in Fullscreen! Modelled and developed entirely, with blood, sweat, and tears, by <a href={"https://ineshd.com"}
                                                                                        className={"text-blue-500"}>Inesh
                    Dey</a>, using <a href="https://react.dev/" className={"text-blue-500"}>React</a> and <a href="https://threejs.org/" className={"text-blue-500"}>Three.js</a>
                </p>
            </div>
            <div
